...
# Learning Reason Analogy Via Retrievalaugmented

[![Python 3.10+](https://img.shields.io/badge/python-3.10%2B-blue.svg)](https://www.python.org/downloads/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)
![CI](https://github.com/regerah/Learning-Reason-Analogy-Via-Retrievalaugmented/actions/workflows/ci.yml/badge.svg)
...
> Zilin Xiao, Qi Ma, Chun-cheng Jason Chen, Xintao Chen, Avinash Atreya et al.
> Published: 2026-06-11 | [Paper Link](http://arxiv.org/abs/2606.13680v1)
...
git clone https://github.com/regerah/Learning-Reason-Analogy-Via-Retrievalaugmented.git
cd Learning-Reason-Analogy-Via-Retrievalaugmented
...
```bibtex
@article{learning_reason_analogy_via_retrievalaugmented_2026,
  title={Learning to Reason by Analogy via Retrieval-Augmented Reinforcement Fine-Tuning},
  author={Zilin Xiao, Qi Ma, Chun-cheng Jason Chen, Xintao Chen, Avinash Atreya et al.},
  year={2026},
